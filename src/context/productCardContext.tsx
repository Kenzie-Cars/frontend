...
export interface IProductCardContext {
    ...
    setCurrentAdvertisement: React.Dispatch<React.SetStateAction<IAdvertisementResponse>>
}
...
export const CurrentProductCardProvider = ({children}: IProductCardContextProps) => {
    const [currentAdvertisement, setCurrentAdvertisement] = useState<IAdvertisementResponse>({} as IAdvertisementResponse)
