...
import { AdvertiserCardContainer } from "../ProductCard/style";
  ...
  return (
    <>
      <AdvertiserCardContainer
        ...
        is_active={advertisementData.is_active}
        discount={advertisementData.is_goodSale}
      >
        <div className="img-container" onClick={test}>
          ...
          <img
            src={advertisementData.cover_img}
            alt={advertisementData.model}
          />
        </div>
        ...
        <div className="advertiser-info">
          <span>
            {advertisementData.user["name"] &&
              defineAcronym(advertisementData.user.name)}
          </span>
...
export const createAdminProductCard = (
